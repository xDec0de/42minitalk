...
#    Updated: 2022/05/11 12:59:53 by danimart         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(NAME): headermk $(SO_FILES) $(CO_FILES)
	@printf "\n\e[0;33m-\e[1;32m "
	$(CC)$(C_FLAGS) $(SO_FILES) -o $(SNAME)
	@printf "\e[0;33m-\e[1;32m "
	$(CC)$(C_FLAGS) $(CO_FILES) -o $(CNAME)
	@printf "\n\033[0m"
clean:
	@printf "\n\e[1;31m> \e[1;36mRemoving \e[1;34m$(NAME)\e[1;36m's objects...\
	\e[1;30m\n\n"
	@printf "\e[0;33m-\e[1;32m "
	rm -rf $(SO_FILES) $(CO_FILES)
	@printf "\n\033[0m"
fclean:
	@printf "\n\e[1;31m> \e[1;36mRemoving \e[1;34m$(NAME)\e[1;36m...\
	\e[1;30m\n\n"
	@printf "\e[0;33m-\e[1;32m "
	rm -rf $(SNAME) $(CNAME) $(SO_FILES) $(CO_FILES)
	@printf "\n\033[0m"
sanitize: headermk $(SO_FILES) $(CO_FILES)
	@printf "\n\e[1;31m- \e[0;33mSanitize enabled\n\e[0;33m-\e[1;32m "
	$(CC)$(C_FLAGS) $(SO_FILES) -o $(SNAME) $(SANITIZE)
	@printf "\e[0;33m-\e[1;32m "
	$(CC)$(C_FLAGS) $(CO_FILES) -o $(CNAME) $(SANITIZE)
	@printf "\n\033[0m"
re: fclean $(NAME)
